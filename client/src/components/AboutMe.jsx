        ...
        <div class="col s12 m7">
          <div class="card">
            <div class="card-image">
              <img src="http://robinsonwd.com/wp-content/uploads/2017/05/aboutDre-1-e1495134823129.jpg" height="450" width="200"/>
            </div>
            ...
            <div class="card-action">
              <a href="/projects">Andre Robinson</a>
            </div>
          </div>
        </div>
        
        <PorjectSection>
        <Link to="/projects"> <h4>My Projects</h4></Link>
        <br/>
